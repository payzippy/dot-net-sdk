<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChargingExample.aspx.cs" Inherits="PayzippyDotNetSDK.ChargingExample" %>
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="terminal_id" name="terminal_id" type="text" value="tid" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="merchant_transaction_id" name="merchant_transaction_id" placeholder = "Enter random number" type="text"
                    class="input-xlarge" required="" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="ui_mode" name="ui_mode" type="text" placeholder="REDIRECT OR IFRAME" class="input-xlarge" required="" runat="server"  />
        </div>
    </div>
</div>
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="buyer_phone_no" name="buyer_phone_no" type="text" value="9999999999" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="buyer_unique_id" name="buyer_unique_id" type="text" value="BID123" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="shipping_city" name="shipping_city" type="text" value="Bangalore" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="shipping_state" name="shipping_state" type="text" placeholder="" value="Karnataka" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="shipping_zip" name="shipping_zip" type="text" placeholder="" value="560034" class="input-xlarge" runat="server" />
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_name" name="billing_name" type="text" class="input-xlarge" value="Biller Name" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_address" name="billing_address" type="text" class="input-xlarge"
                   value="Payzippy, Koramangala" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_city" name="billing_city" type="text" class="input-xlarge" value="Bangalore" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_state" name="billing_state" type="text" placeholder="" value="Karnataka" class="input-xlarge" runat="server"  />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_zip" name="billing_zip" type="text" class="input-xlarge" value="560034" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="billing_country" name="billing_country" type="text" class="input-xlarge" value="India" runat="server" />
        </div>
    </div>
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
         <input id="transaction_type" name="transaction_type" type="text" value="SALE" class="input-xlarge"
    ...
    <!-- Select Basic -->
    <div class="control-group">
        <label class="control-label required" title ="CREDIT/ DEBIT/ NET/ PAYZIPPY/ EMI">Payment Method</label>

        <div class="controls">
          <input id="payment_method" name="payment_method" type="text" value ="PAYZIPPY"  title ="CREDIT/ DEBIT/ NET/ PAYZIPPY/ EMI" class="input-xlarge" required="" runat="server"/>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
           <input id="emi_months" name="emi_months" type="text" value="0" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        <input id="currency" name="currency" type="text" value="INR" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="bank_name" name="bank_name" type="text" value="HDFC" class="input-xlarge" runat="server" />
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="min_sla" name="min_sla" type="text" value="4" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        <input id = "is_user_logged_in" name = "is_user_logged_in" type="text" value="false" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="address_count" name="address_count" type="text" value="3" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="sales_channel" name="sales_channel" type="text" value="Mobile" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="item_total" name="item_total" type="text" value="2000,1200" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="item_vertical" name="item_vertical" type="text" value="books,sports" class="input-xlarge" runat="server" />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="sms_notify_number" name="sms_notify_number" type="text" value="9999999999" class="input-xlarge" runat="server" />
        </div>
    </div>
...
<div class="well well-small span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="source" name="source" type="text" value="testpage" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="product_info1" name="product_info1" type="text" value="physical" class="input-xlarge" runat="server" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="product_info2" name="product_info2" type="text" value="mobile" class="input-xlarge" runat="server"  />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="product_info3" name="product_info3" type="text" value="samsung galaxy" class="input-xlarge" runat="server" />
...
<div class="control-group span12">
    <input type="submit" id="button" class="btn btn-info" runat="server" value="Pay with PayZippy" OnServerClick = "Charge_OnClick" />
</div>
